...
include struct
  ...
  let u_typ x___1008 = Snarky.Typ.Internal.ref ()
end
...
include struct
  ...
  let v_typ x___1013 x___1012 = Snarky.Typ.Internal.ref ()
end
...
module A = struct
  include struct
    ...
    let opaque_typ x___1023 x___1022 =
      { Snarky.Types.Typ.store=
          (fun (x0, x1) ->
            Snarky.Typ_monads.Store.bind (x___1023.Snarky.Types.Typ.store x0)
              ~f:(fun x0 ->
                Snarky.Typ_monads.Store.bind
                  (x___1022.Snarky.Types.Typ.store x1) ~f:(fun x1 ->
                    Snarky.Typ_monads.Store.return (x0, x1) ) ) )
      ; Snarky.Types.Typ.read=
          (fun (x0, x1) ->
            Snarky.Typ_monads.Read.bind (x___1023.Snarky.Types.Typ.read x0)
              ~f:(fun x0 ->
                Snarky.Typ_monads.Read.bind (x___1022.Snarky.Types.Typ.read x1)
                  ~f:(fun x1 -> Snarky.Typ_monads.Read.return (x0, x1)) ) )
      ; Snarky.Types.Typ.alloc=
          Snarky.Typ_mondas.Alloc.bind x___1023.Snarky.Types.Typ.alloc
            ~f:(fun x0 ->
              Snarky.Typ_mondas.Alloc.bind x___1022.Snarky.Types.Typ.alloc
                ~f:(fun x1 -> Snarky.Typ_monads.Alloc.return (x0, x1)) )
      ; Snarky.Types.Typ.check=
          (fun (x0, x1) ->
            Snarky.Checked.bind (x___1023.Snarky.Types.Typ.check x0)
              ~f:(fun () ->
                Snarky.Checked.bind (x___1022.Snarky.Types.Typ.check x1)
