 ...
 *****************************************************************************
 ...
 The command
     ...
     $ libsnark/zk_proof_systems/ppzksnark/r1cs_bg_ppzksnark/profiling/profile_r1cs_bg_ppzksnark 1000 10 Fr
 ...
 The command
     ...
     $ libsnark/zk_proof_systems/ppzksnark/r1cs_bg_ppzksnark/profiling/profile_r1cs_bg_ppzksnark 1000 10 bytes
...
#include <libsnark/common/default_types/r1cs_bg_ppzksnark_pp.hpp>
#include <libsnark/relations/constraint_satisfaction_problems/r1cs/examples/r1cs_examples.hpp>
#include <libsnark/zk_proof_systems/ppzksnark/r1cs_bg_ppzksnark/examples/run_r1cs_bg_ppzksnark.hpp>

using namespace libsnark;

int main(int argc, const char * argv[])
{
    default_r1cs_bg_ppzksnark_pp::init_public_params();
    ...
    r1cs_example<libff::Fr<default_r1cs_bg_ppzksnark_pp> > example = generate_r1cs_example_with_field_input<libff::Fr<default_r1cs_bg_ppzksnark_pp> >(num_constraints, input_size);
    libff::leave_block("Generate R1CS example");

    libff::print_header("(enter) Profile R1CS BG-ppzkSNARK");
    const bool test_serialization = true;
    run_r1cs_bg_ppzksnark<default_r1cs_bg_ppzksnark_pp>(example, test_serialization);
    libff::print_header("(leave) Profile R1CS BG-ppzkSNARK");
}
