...
bool camlsnark_mnt4_g1_is_zero(libff::G1<ppT>* a) {
  return a->is_zero();
}
...
char *camlsnark_mnt4_g1_to_string(libff::G1<ppT>* a) {
  a->output_pretty();
}
...
bool camlsnark_mnt4_g2_is_zero(libff::G2<ppT>* a) {
  return a->is_zero();
}
...
char *camlsnark_mnt4_g2_to_string(libff::G2<ppT>* a) {
  a->output_pretty();
}
