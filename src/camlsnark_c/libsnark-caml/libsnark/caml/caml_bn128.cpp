...
libff::bigint<libff::bn128_r_limbs>* CURVE_PREFIX(field_size)() {
...
// bigint bn128_r
libff::bigint<libff::bn128_r_limbs>* CURVE_PREFIX(bigint_r_of_field)(FieldT* x) {
  return new libff::bigint<libff::bn128_r_limbs>(x->as_bigint());
}

libff::bigint<libff::bn128_r_limbs>* CURVE_PREFIX(bigint_r_of_decimal_string)(char* x) {
...
char* CURVE_PREFIX(bigint_r_to_data)(libff::bigint<libff::bn128_r_limbs>* x) {
  return (char *) x->data;
}

libff::bigint<libff::bn128_r_limbs>* CURVE_PREFIX(bigint_r_of_data)(char* s) {
...
libff::bigint<libff::bn128_r_limbs>* CURVE_PREFIX(bigint_r_div)(
...
FieldT* CURVE_PREFIX(bigint_r_to_field)(libff::bigint<libff::bn128_r_limbs>* n) {
  return new FieldT(*n);
}

libff::bigint<libff::bn128_r_limbs>* CURVE_PREFIX(bigint_r_of_numeral)(const unsigned char* s, int s_length, int base) {
...
bool CURVE_PREFIX(bigint_r_test_bit)(libff::bigint<libff::bn128_r_limbs>* n, int i) {
  return n->test_bit(i);
}

void CURVE_PREFIX(bigint_r_delete)(libff::bigint<libff::bn128_r_limbs>* n) {
  delete n;
}

void CURVE_PREFIX(bigint_r_print)(libff::bigint<libff::bn128_r_limbs>* n) {
  n->print();
}
...
// bigint bn128_q
bool CURVE_PREFIX(bigint_q_test_bit)(libff::bigint<libff::bn128_q_limbs>* n, int i) {
  return n->test_bit(i);
}

void CURVE_PREFIX(bigint_q_delete)(libff::bigint<libff::bn128_q_limbs>* n) {
  delete n;
}

void CURVE_PREFIX(bigint_q_print)(libff::bigint<libff::bn128_q_limbs>* n) {
  n->print();
}
