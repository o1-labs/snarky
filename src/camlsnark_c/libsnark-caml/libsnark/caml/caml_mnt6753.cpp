...
libff::bigint<libff::mnt6753_r_limbs>* CURVE_PREFIX(field_size)() {
...
// bigint mnt6753_r
libff::bigint<libff::mnt6753_r_limbs>* CURVE_PREFIX(bigint_r_of_field)(FieldT* x) {
  return new libff::bigint<libff::mnt6753_r_limbs>(x->as_bigint());
}

libff::bigint<libff::mnt6753_r_limbs>* CURVE_PREFIX(bigint_r_of_decimal_string)(char* x) {
...
char* CURVE_PREFIX(bigint_r_to_data)(libff::bigint<libff::mnt6753_r_limbs>* x) {
  return (char *) x->data;
}

libff::bigint<libff::mnt6753_r_limbs>* CURVE_PREFIX(bigint_r_of_data)(char* s) {
...
libff::bigint<libff::mnt6753_r_limbs>* CURVE_PREFIX(bigint_r_div)(
...
FieldT* CURVE_PREFIX(bigint_r_to_field)(libff::bigint<libff::mnt6753_r_limbs>* n) {
  return new FieldT(*n);
}

libff::bigint<libff::mnt6753_r_limbs>* CURVE_PREFIX(bigint_r_of_numeral)(const unsigned char* s, int s_length, int base) {
...
bool CURVE_PREFIX(bigint_r_test_bit)(libff::bigint<libff::mnt6753_r_limbs>* n, int i) {
  return n->test_bit(i);
}

void CURVE_PREFIX(bigint_r_delete)(libff::bigint<libff::mnt6753_r_limbs>* n) {
  delete n;
}

void CURVE_PREFIX(bigint_r_print)(libff::bigint<libff::mnt6753_r_limbs>* n) {
  n->print();
}
...
// bigint mnt6753_q
bool CURVE_PREFIX(bigint_q_test_bit)(libff::bigint<libff::mnt6753_q_limbs>* n, int i) {
  return n->test_bit(i);
}

void CURVE_PREFIX(bigint_q_delete)(libff::bigint<libff::mnt6753_q_limbs>* n) {
  delete n;
}

void CURVE_PREFIX(bigint_q_print)(libff::bigint<libff::mnt6753_q_limbs>* n) {
  n->print();
}
...
const linear_combination<FieldT>* CURVE_PREFIX(r1cs_constraint_a)(const r1cs_constraint<FieldT>* c) {
  return &c->a;
}

const linear_combination<FieldT>* CURVE_PREFIX(r1cs_constraint_b)(const r1cs_constraint<FieldT>* c) {
  return &c->b;
}

const linear_combination<FieldT>* CURVE_PREFIX(r1cs_constraint_c)(const r1cs_constraint<FieldT>* c) {
  return &c->c;
}
...
std::vector<libff::G1<ppT>>* CURVE_PREFIX(g1_create_window_table)(libff::G1<ppT>* base) {
  return new std::vector<libff::G1<ppT>>(
      libff::create_window_table<libff::G1<ppT>>(*base));
}

libff::G1<ppT>* CURVE_PREFIX(g1_window_scalar_mul)(
