...
FieldT* camlsnark_mnt6_field_of_int(long n) {
  return new FieldT(n);
}
...
void camlsnark_mnt6_field_mut_add(FieldT* x, FieldT* y) {
  *x += *y;
}

void camlsnark_mnt6_field_mut_mul(FieldT* x, FieldT* y) {
  *x *= *y;
}

void camlsnark_mnt6_field_mut_sub(FieldT* x, FieldT* y) {
  *x -= *y;
}

void camlsnark_mnt6_field_copy(FieldT* x, FieldT* y) {
...
const linear_combination<FieldT>* camlsnark_mnt6_r1cs_constraint_a(const r1cs_constraint<FieldT>* c) {
  return &c->a;
}

const linear_combination<FieldT>* camlsnark_mnt6_r1cs_constraint_b(const r1cs_constraint<FieldT>* c) {
  return &c->b;
}

const linear_combination<FieldT>* camlsnark_mnt6_r1cs_constraint_c(const r1cs_constraint<FieldT>* c) {
  return &c->c;
}
...
void camlsnark_mnt6_r1cs_constraint_system_iter(
    r1cs_constraint_system<FieldT>* sys,
...
r1cs_gg_ppzksnark_keypair<ppT>* camlsnark_mnt6_keypair_of_keys(
    r1cs_gg_ppzksnark_proving_key<ppT>* pk,
    r1cs_gg_ppzksnark_verification_key<ppT>* vk) {
...
bool camlsnark_mnt6_keypair_check(r1cs_gg_ppzksnark_keypair<ppT>* keypair) {
...
r1cs_se_ppzksnark_keypair<ppT>* camlsnark_mnt6_gm_keypair_of_keys(
    r1cs_se_ppzksnark_proving_key<ppT>* pk,
    r1cs_se_ppzksnark_verification_key<ppT>* vk) {
...
bool camlsnark_mnt6_gm_keypair_check(r1cs_gg_ppzksnark_keypair<ppT>* keypair) {
  return true;
}
...
r1cs_constraint_system<FieldT>* camlsnark_mnt6_bg_proving_key_r1cs_constraint_system(
...
std::vector<libff::G1<ppT>>*
camlsnark_mnt6_bg_verification_key_query(r1cs_bg_ppzksnark_verification_key<ppT>* vk) {
  std::vector<libff::G1<ppT>>* res = new std::vector<libff::G1<ppT>>();
  res->emplace_back(vk->ABC_g1.first);
  for (size_t i = 0; i < vk->ABC_g1.rest.values.size(); ++i)
  {
...
libff::G2<ppT>*
camlsnark_mnt6_bg_verification_key_delta(r1cs_bg_ppzksnark_verification_key<ppT>* vk) {
  return new libff::G2<ppT>(vk->delta_g2);
}

libff::Fqk<ppT>*
camlsnark_mnt6_bg_verification_key_alpha_beta(r1cs_bg_ppzksnark_verification_key<ppT>* vk) {
  return new libff::Fqk<ppT>(vk->alpha_g1_beta_g2);
}
...
r1cs_bg_ppzksnark_keypair<ppT>* camlsnark_mnt6_bg_keypair_of_keys(
    r1cs_bg_ppzksnark_proving_key<ppT>* pk,
    r1cs_bg_ppzksnark_verification_key<ppT>* vk) {
...
bool camlsnark_mnt6_bg_keypair_check(r1cs_bg_ppzksnark_keypair<ppT>* keypair) {
  return keypair->pk.delta_g2 == keypair->vk.delta_g2;
}
...
libff::G2<ppT>* camlsnark_mnt6_bg_proof_b(r1cs_bg_ppzksnark_proof<ppT>* proof) {
  return new libff::G2<ppT>(proof->g_B);
}

libff::G1<ppT>* camlsnark_mnt6_bg_proof_c(r1cs_bg_ppzksnark_proof<ppT>* proof) {
  return new libff::G1<ppT>(proof->g_C);
}

libff::G2<ppT>* camlsnark_mnt6_bg_proof_delta_prime(r1cs_bg_ppzksnark_proof<ppT>* proof) {
...
std::vector<libff::G1<ppT>>* camlsnark_mnt6_g1_create_window_table(libff::G1<ppT>* base) {
  return new std::vector<libff::G1<ppT>>(
      libff::create_window_table<libff::G1<ppT>>(*base));
}

libff::G1<ppT>* camlsnark_mnt6_g1_window_scalar_mul(
