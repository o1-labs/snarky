              ...
              field_subset_type domain_type)
{
    ...
    const std::size_t num_oracles_input = 4;
    const std::size_t num_oracles_target = 4;
    ...
    interleaved_lincheck_ot_protocol<FieldT> linconstraints(IOP,
    ...
    linconstraints.attach_target_vector_row_oracles(target_vector_handles);
    if (make_zk)
    {
    ...
    std::vector<oracle<FieldT>> input_row_oracles = generate_row_oracles<FieldT>(input_vector,
                                                                                 ...
                                                                                 systematic_domain,
                                                                                 codeword_domain);
    std::vector<oracle<FieldT>> target_row_oracles = generate_row_oracles<FieldT>(target_vector,
                                                                                  num_oracles_target,
                                                                                  systematic_domain,
                                                                                  codeword_domain);
    for (size_t i = 0; i < num_oracles_input; ++i)
    ...
    for (size_t i = 0; i < num_oracles_target; ++i)
    {
        IOP.submit_oracle(target_vector_handles[i], std::move(target_row_oracles[i]));
    }
