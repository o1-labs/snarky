...
#ifndef LIBIOP_RELATIONS_VARIABLE_HPP_
#define LIBIOP_RELATIONS_VARIABLE_HPP_
...
public:
    ...
    variable(const var_index_t index = 0) : index_(index) {};
...
#include <libiop/relations/variable.tcc>

#endif // LIBIOP_RELATIONS_VARIABLE_HPP_
