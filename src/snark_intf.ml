...
module type Basic = sig
  ...
  module rec Constraint : sig
    (** The type of constraints.
        ...
        these variables, each times by a field constant ({!type:Field.t}); any
        time we want to multiply our *variables*, we need to add a new rank-1
        constraint.
    *)
    ...
    module Checked : sig
      ...
      *)
      ...
      (** [div x y] returns the result of dividing the R1CS variable [x] by
          ...
          If [x] is not an integer multiple of [y], the result may be any
