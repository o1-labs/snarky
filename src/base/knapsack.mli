module Make (M : Snark_intf.Basic) : sig
  ...
  module Hash (M : sig
    ...
    val hash : var -> var -> var Checked.t

    val assert_equal : var -> var -> unit Checked.t
  end

  module Checked : sig
    val hash_to_field : t -> Boolean.var list -> Field.Var.t list Checked.t

    val hash_to_bits : t -> Boolean.var list -> Boolean.var list Checked.t
  end
end
